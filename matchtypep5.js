...
function setup() {
  ...
  fonts[0] = loadFont('assets/Suisse-Works-Medium.otf');
  fonts[1] = loadFont('assets/Druk-Wide-Medium-Desktop.otf');
  fonts[2] = loadFont('assets/le-murmure.ttf');
  fonts[3] = loadFont('assets/Pilowlava-Regular.otf');
  fonts[4] = loadFont('assets/terminal-grotesque.ttf');
...
function mousePressed() {
  ...
  if (clickCounter === 1) {
    ...
    if (abs(posX - bufferPosX) + abs(posY - bufferPosY) === 1) {
      ...
      clickCounter = 1; // Сброс второго клика
    }
  }
}
